...
/***/ "./build.definitions/RisksMobile/Rules/service1/Mitigations/Mitigations_CreateRisk.js":
/*!********************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/service1/Mitigations/Mitigations_CreateRisk.js ***!
  \********************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function CreateRelatedEntity(clientAPI) {
    if (clientAPI.getODataProvider('/RisksMobile/Services/service1.service').isDraftEnabled('Mitigations')) {
        ...
        return clientAPI.executeAction({
            'Name': '/RisksMobile/Actions/service1/Mitigations/Mitigations_CreateRisk.action',
            'Properties': {
                'OnSuccess': ''
            }
        }).then((result) => {
        ...
        return clientAPI.executeAction('/RisksMobile/Actions/service1/Mitigations/Mitigations_CreateRisk.action');
    }
}
...
/***/ "./build.definitions/RisksMobile/Rules/service1/Mitigations/NavToMitigations_CreateRisk.js":
/*!*************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/service1/Mitigations/NavToMitigations_CreateRisk.js ***!
  \*************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    if (clientAPI.getODataProvider('/RisksMobile/Services/service1.service').isDraftEnabled('Mitigations')) {
        return clientAPI.executeAction({
            ...
            'Properties': {
                ...
                'OnSuccess': '/RisksMobile/Actions/service1/Mitigations/NavToMitigations_CreateRisk.action'
            }
        });
    } else {
        return clientAPI.executeAction('/RisksMobile/Actions/service1/Mitigations/NavToMitigations_CreateRisk.action');
    }
}
...
/***/ "./build.definitions/RisksMobile/Rules/service1/Risk/NavToRisk_Edit.js":
/*!*****************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/service1/Risk/NavToRisk_Edit.js ***!
  \*****************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./build.definitions/RisksMobile/Rules/service1/Risk/Risk_Cancel.js":
/*!**************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/service1/Risk/Risk_Cancel.js ***!
  \**************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./build.definitions/RisksMobile/Rules/service1/Risk/Risk_CreateEntity.js":
/*!********************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/service1/Risk/Risk_CreateEntity.js ***!
  \********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./build.definitions/RisksMobile/Rules/service1/Risk/Risk_DeleteConfirmation.js":
/*!**************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/service1/Risk/Risk_DeleteConfirmation.js ***!
  \**************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function DeleteConfirmation(clientAPI) {
    return clientAPI.executeAction('/RisksMobile/Actions/DeleteConfirmation.action').then((result) => {
        if (result.data) {
            return clientAPI.executeAction('/RisksMobile/Actions/service1/Risk/Risk_DeleteEntity.action').then(
                (success) => Promise.resolve(success),
                (failure) => Promise.reject('Delete entity failed ' + failure));
        } else {
            return Promise.reject('User Deferred');
...
/***/ "./build.definitions/RisksMobile/Rules/service1/Risk/Risk_UpdateEntity.js":
/*!********************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/service1/Risk/Risk_UpdateEntity.js ***!
  \********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
let risksmobile_actions_service1_mitigations_mitigations_createrisk_action = __webpack_require__(/*! ./RisksMobile/Actions/service1/Mitigations/Mitigations_CreateRisk.action */ "./build.definitions/RisksMobile/Actions/service1/Mitigations/Mitigations_CreateRisk.action")
...
let risksmobile_actions_service1_mitigations_navtomitigations_createrisk_action = __webpack_require__(/*! ./RisksMobile/Actions/service1/Mitigations/NavToMitigations_CreateRisk.action */ "./build.definitions/RisksMobile/Actions/service1/Mitigations/NavToMitigations_CreateRisk.action")
...
let risksmobile_actions_service1_risk_navtorisk_create_action = __webpack_require__(/*! ./RisksMobile/Actions/service1/Risk/NavToRisk_Create.action */ "./build.definitions/RisksMobile/Actions/service1/Risk/NavToRisk_Create.action")
let risksmobile_actions_service1_risk_navtorisk_detail_action = __webpack_require__(/*! ./RisksMobile/Actions/service1/Risk/NavToRisk_Detail.action */ "./build.definitions/RisksMobile/Actions/service1/Risk/NavToRisk_Detail.action")
let risksmobile_actions_service1_risk_navtorisk_edit_action = __webpack_require__(/*! ./RisksMobile/Actions/service1/Risk/NavToRisk_Edit.action */ "./build.definitions/RisksMobile/Actions/service1/Risk/NavToRisk_Edit.action")
let risksmobile_actions_service1_risk_navtorisk_list_action = __webpack_require__(/*! ./RisksMobile/Actions/service1/Risk/NavToRisk_List.action */ "./build.definitions/RisksMobile/Actions/service1/Risk/NavToRisk_List.action")
let risksmobile_actions_service1_risk_risk_createentity_action = __webpack_require__(/*! ./RisksMobile/Actions/service1/Risk/Risk_CreateEntity.action */ "./build.definitions/RisksMobile/Actions/service1/Risk/Risk_CreateEntity.action")
let risksmobile_actions_service1_risk_risk_deleteentity_action = __webpack_require__(/*! ./RisksMobile/Actions/service1/Risk/Risk_DeleteEntity.action */ "./build.definitions/RisksMobile/Actions/service1/Risk/Risk_DeleteEntity.action")
let risksmobile_actions_service1_risk_risk_updateentity_action = __webpack_require__(/*! ./RisksMobile/Actions/service1/Risk/Risk_UpdateEntity.action */ "./build.definitions/RisksMobile/Actions/service1/Risk/Risk_UpdateEntity.action")
...
let risksmobile_pages_service1_mitigations_mitigations_createrisk_page = __webpack_require__(/*! ./RisksMobile/Pages/service1_Mitigations/Mitigations_CreateRisk.page */ "./build.definitions/RisksMobile/Pages/service1_Mitigations/Mitigations_CreateRisk.page")
...
let risksmobile_pages_service1_risk_risk_create_page = __webpack_require__(/*! ./RisksMobile/Pages/service1_Risk/Risk_Create.page */ "./build.definitions/RisksMobile/Pages/service1_Risk/Risk_Create.page")
let risksmobile_pages_service1_risk_risk_detail_page = __webpack_require__(/*! ./RisksMobile/Pages/service1_Risk/Risk_Detail.page */ "./build.definitions/RisksMobile/Pages/service1_Risk/Risk_Detail.page")
let risksmobile_pages_service1_risk_risk_edit_page = __webpack_require__(/*! ./RisksMobile/Pages/service1_Risk/Risk_Edit.page */ "./build.definitions/RisksMobile/Pages/service1_Risk/Risk_Edit.page")
let risksmobile_pages_service1_risk_risk_list_page = __webpack_require__(/*! ./RisksMobile/Pages/service1_Risk/Risk_List.page */ "./build.definitions/RisksMobile/Pages/service1_Risk/Risk_List.page")
...
let risksmobile_rules_service1_mitigations_mitigations_createrisk_js = __webpack_require__(/*! ./RisksMobile/Rules/service1/Mitigations/Mitigations_CreateRisk.js */ "./build.definitions/RisksMobile/Rules/service1/Mitigations/Mitigations_CreateRisk.js")
...
let risksmobile_rules_service1_mitigations_navtomitigations_createrisk_js = __webpack_require__(/*! ./RisksMobile/Rules/service1/Mitigations/NavToMitigations_CreateRisk.js */ "./build.definitions/RisksMobile/Rules/service1/Mitigations/NavToMitigations_CreateRisk.js")
...
let risksmobile_rules_service1_risk_navtorisk_edit_js = __webpack_require__(/*! ./RisksMobile/Rules/service1/Risk/NavToRisk_Edit.js */ "./build.definitions/RisksMobile/Rules/service1/Risk/NavToRisk_Edit.js")
let risksmobile_rules_service1_risk_risk_cancel_js = __webpack_require__(/*! ./RisksMobile/Rules/service1/Risk/Risk_Cancel.js */ "./build.definitions/RisksMobile/Rules/service1/Risk/Risk_Cancel.js")
let risksmobile_rules_service1_risk_risk_createentity_js = __webpack_require__(/*! ./RisksMobile/Rules/service1/Risk/Risk_CreateEntity.js */ "./build.definitions/RisksMobile/Rules/service1/Risk/Risk_CreateEntity.js")
let risksmobile_rules_service1_risk_risk_deleteconfirmation_js = __webpack_require__(/*! ./RisksMobile/Rules/service1/Risk/Risk_DeleteConfirmation.js */ "./build.definitions/RisksMobile/Rules/service1/Risk/Risk_DeleteConfirmation.js")
let risksmobile_rules_service1_risk_risk_updateentity_js = __webpack_require__(/*! ./RisksMobile/Rules/service1/Risk/Risk_UpdateEntity.js */ "./build.definitions/RisksMobile/Rules/service1/Risk/Risk_UpdateEntity.js")
...
module.exports = {
	...
	risksmobile_actions_service1_mitigations_mitigations_createrisk_action : risksmobile_actions_service1_mitigations_mitigations_createrisk_action,
	...
	risksmobile_actions_service1_mitigations_navtomitigations_createrisk_action : risksmobile_actions_service1_mitigations_navtomitigations_createrisk_action,
	...
	risksmobile_actions_service1_risk_navtorisk_create_action : risksmobile_actions_service1_risk_navtorisk_create_action,
	risksmobile_actions_service1_risk_navtorisk_detail_action : risksmobile_actions_service1_risk_navtorisk_detail_action,
	risksmobile_actions_service1_risk_navtorisk_edit_action : risksmobile_actions_service1_risk_navtorisk_edit_action,
	risksmobile_actions_service1_risk_navtorisk_list_action : risksmobile_actions_service1_risk_navtorisk_list_action,
	risksmobile_actions_service1_risk_risk_createentity_action : risksmobile_actions_service1_risk_risk_createentity_action,
	risksmobile_actions_service1_risk_risk_deleteentity_action : risksmobile_actions_service1_risk_risk_deleteentity_action,
	risksmobile_actions_service1_risk_risk_updateentity_action : risksmobile_actions_service1_risk_risk_updateentity_action,
	...
	risksmobile_pages_service1_mitigations_mitigations_createrisk_page : risksmobile_pages_service1_mitigations_mitigations_createrisk_page,
	...
	risksmobile_pages_service1_risk_risk_create_page : risksmobile_pages_service1_risk_risk_create_page,
	risksmobile_pages_service1_risk_risk_detail_page : risksmobile_pages_service1_risk_risk_detail_page,
	risksmobile_pages_service1_risk_risk_edit_page : risksmobile_pages_service1_risk_risk_edit_page,
	risksmobile_pages_service1_risk_risk_list_page : risksmobile_pages_service1_risk_risk_list_page,
	...
	risksmobile_rules_service1_mitigations_mitigations_createrisk_js : risksmobile_rules_service1_mitigations_mitigations_createrisk_js,
	...
	risksmobile_rules_service1_mitigations_navtomitigations_createrisk_js : risksmobile_rules_service1_mitigations_navtomitigations_createrisk_js,
	...
	risksmobile_rules_service1_risk_navtorisk_edit_js : risksmobile_rules_service1_risk_navtorisk_edit_js,
	risksmobile_rules_service1_risk_risk_cancel_js : risksmobile_rules_service1_risk_risk_cancel_js,
	risksmobile_rules_service1_risk_risk_createentity_js : risksmobile_rules_service1_risk_risk_createentity_js,
	risksmobile_rules_service1_risk_risk_deleteconfirmation_js : risksmobile_rules_service1_risk_risk_deleteconfirmation_js,
	risksmobile_rules_service1_risk_risk_updateentity_js : risksmobile_rules_service1_risk_risk_updateentity_js,
...
/***/ "./build.definitions/RisksMobile/Pages/service1_Risk/Risk_Create.page":
/*!****************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Pages/service1_Risk/Risk_Create.page ***!
  \****************************************************************************/
/***/ ((module) => {

module.exports = {"ActionBar":{"Items":[{"OnPress":"/RisksMobile/Actions/CloseModalPage_Cancel.action","Position":"Left","SystemItem":"Cancel"},{"OnPress":"/RisksMobile/Rules/service1/Risk/Risk_CreateEntity.js","Position":"Right","SystemItem":"Save"}]},"Caption":"Create Risk Detail","Controls":[{"Sections":[{"_Type":"Section.Type.FormCell","_Name":"SectionFormCell0","Visible":true,"Controls":[{"Caption":"title","_Name":"title","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"prio","_Name":"prio","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"descr","_Name":"descr","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"impact","KeyboardType":"Number","_Name":"impact","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"criticality","KeyboardType":"Number","_Name":"criticality","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"supplier_BusinessPartner","AllowMultipleSelection":false,"AllowEmptySelection":true,"IsEditable":true,"IsPickerDismissedOnSelection":true,"IsSelectedSectionEnabled":true,"PickerItems":{"DisplayValue":"{BusinessPartnerFullName}","ReturnValue":"{BusinessPartner}","Target":{"EntitySet":"A_BusinessPartner","Service":"/RisksMobile/Services/service1.service"}},"_Name":"supplier_BusinessPartner","_Type":"Control.Type.FormCell.ListPicker"}]}],"_Name":"SectionedTable0","_Type":"Control.Type.SectionedTable"}],"_Type":"Page","_Name":"Risk_Create","PrefersLargeCaption":true}

/***/ }),

/***/ "./build.definitions/RisksMobile/Pages/service1_Risk/Risk_Detail.page":
/*!****************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Pages/service1_Risk/Risk_Detail.page ***!
  \****************************************************************************/
/***/ ((module) => {

module.exports = {"Caption":"Risk Detail","DesignTimeTarget":{"Service":"/RisksMobile/Services/service1.service","EntitySet":"Risk","QueryOptions":""},"ActionBar":{"Items":[{"OnPress":"/RisksMobile/Rules/service1/Risk/NavToRisk_Edit.js","Position":"Right","SystemItem":"Edit"},{"OnPress":"/RisksMobile/Rules/service1/Risk/Risk_DeleteConfirmation.js","Position":"Right","SystemItem":"Trash"}]},"Controls":[{"Sections":[{"ObjectHeader":{"Tags":[],"DetailImage":"","HeadlineText":"{title}","Subhead":"{createdAt}","BodyText":"","Footnote":"{modifiedAt}","Description":"{createdBy}","StatusText":"{modifiedBy}","StatusImage":"","SubstatusImage":"","SubstatusText":"{prio}"},"_Type":"Section.Type.ObjectHeader"},{"KeyAndValues":[{"KeyName":"$(L,CreatedAt)","Value":"{createdAt}"},{"KeyName":"$(L,CreatedBy)","Value":"{createdBy}"},{"KeyName":"$(L,ChangedAt)","Value":"{modifiedAt}"},{"KeyName":"$(L,ChangedBy)","Value":"{modifiedBy}"},{"KeyName":"title","Value":"{title}"},{"KeyName":"prio","Value":"{prio}"},{"KeyName":"descr","Value":"{descr}"},{"KeyName":"impact","Value":"{impact}"},{"KeyName":"criticality","Value":"{criticality}"},{"KeyName":"supplier_BusinessPartner","Value":"{supplier_BusinessPartner}"}],"Layout":{"NumberOfColumns":2},"MaxItemCount":1,"_Name":"SectionKeyValue0","_Type":"Section.Type.KeyValue"}],"DataSubscriptions":[],"_Type":"Control.Type.SectionedTable","_Name":"SectionedTable"}],"_Type":"Page","_Name":"Risk_Detail","PrefersLargeCaption":true}

/***/ }),

/***/ "./build.definitions/RisksMobile/Pages/service1_Risk/Risk_Edit.page":
/*!**************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Pages/service1_Risk/Risk_Edit.page ***!
  \**************************************************************************/
/***/ ((module) => {

module.exports = {"Caption":"Update Risk Detail","DesignTimeTarget":{"Service":"/RisksMobile/Services/service1.service","EntitySet":"Risk","QueryOptions":""},"ActionBar":{"Items":[{"Position":"Left","Caption":"Cancel","OnPress":"/RisksMobile/Rules/service1/Risk/Risk_Cancel.js"},{"Position":"Right","SystemItem":"Save","OnPress":"/RisksMobile/Rules/service1/Risk/Risk_UpdateEntity.js"}]},"Controls":[{"Sections":[{"_Type":"Section.Type.FormCell","_Name":"SectionFormCell0","Visible":true,"Controls":[{"Caption":"title","_Name":"title","Value":"{title}","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"prio","_Name":"prio","Value":"{prio}","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"descr","_Name":"descr","Value":"{descr}","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"impact","_Name":"impact","Value":"{impact}","KeyboardType":"Number","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"criticality","_Name":"criticality","Value":"{criticality}","KeyboardType":"Number","_Type":"Control.Type.FormCell.SimpleProperty"},{"Caption":"supplier_BusinessPartner","AllowMultipleSelection":false,"AllowEmptySelection":true,"IsPickerDismissedOnSelection":true,"IsSelectedSectionEnabled":true,"PickerItems":{"DisplayValue":"{BusinessPartnerFullName}","ReturnValue":"{BusinessPartner}","Target":{"EntitySet":"A_BusinessPartner","Service":"/RisksMobile/Services/service1.service"}},"Value":"{supplier_BusinessPartner}","_Name":"supplier_BusinessPartner","_Type":"Control.Type.FormCell.ListPicker"}]}],"_Name":"SectionedTable0","_Type":"Control.Type.SectionedTable"}],"_Type":"Page","_Name":"Risk_Edit","PrefersLargeCaption":true}

/***/ }),

/***/ "./build.definitions/RisksMobile/Pages/service1_Risk/Risk_List.page":
/*!**************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Pages/service1_Risk/Risk_List.page ***!
  \**************************************************************************/
/***/ ((module) => {

module.exports = {"Caption":"Risk","ActionBar":{"Items":[{"OnPress":"/RisksMobile/Actions/service1/Risk/NavToRisk_Create.action","Position":"Right","SystemItem":"Add"}]},"Controls":[{"Sections":[{"Header":{"UseTopPadding":false},"ObjectCell":{"AccessoryType":"DisclosureIndicator","Description":"{createdBy}","AvatarStack":{"Avatars":[{"Image":""}],"ImageIsCircular":false},"Icons":[],"OnPress":"/RisksMobile/Actions/service1/Risk/NavToRisk_Detail.action","StatusImage":"","Title":"{title}","Footnote":"{modifiedAt}","PreserveIconStackSpacing":false,"StatusText":"{modifiedBy}","Subhead":"{createdAt}","SubstatusText":"{prio}"},"EmptySection":{"Caption":"No record found!"},"Search":{"Enabled":true,"Placeholder":"Item Search","BarcodeScanner":true,"Delay":500,"MinimumCharacterThreshold":3},"DataPaging":{"ShowLoadingIndicator":true,"LoadingIndicatorText":"Loading more items, please wait..."},"Target":{"EntitySet":"Risk","Service":"/RisksMobile/Services/service1.service","QueryOptions":""},"_Type":"Section.Type.ObjectTable"}],"LoadingIndicator":{"Enabled":true,"Text":"Loading, please wait..."},"_Type":"Control.Type.SectionedTable","_Name":"SectionedTable"}],"_Type":"Page","_Name":"Risk_List","PrefersLargeCaption":true}
...
module.exports = {"PopoverItems":[{"Title":"Add Risk","OnPress":"/RisksMobile/Rules/service1/Mitigations/NavToMitigations_CreateRisk.js"},{"Title":"Delete","OnPress":"/RisksMobile/Rules/service1/Mitigations/Mitigations_DeleteConfirmation.js"}],"_Type":"Action.Type.PopoverMenu"}
...
/***/ "./build.definitions/RisksMobile/Actions/service1/Mitigations/NavToMitigations_CreateRisk.action":
/*!*******************************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/service1/Mitigations/NavToMitigations_CreateRisk.action ***!
  \*******************************************************************************************************/
/***/ ((module) => {

module.exports = {"ModalPageFullscreen":false,"ModalPage":true,"PageToOpen":"/RisksMobile/Pages/service1_Mitigations/Mitigations_CreateRisk.page","_Type":"Action.Type.Navigation"}
...
/***/ "./build.definitions/RisksMobile/Actions/service1/Risk/NavToRisk_Create.action":
/*!*************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/service1/Risk/NavToRisk_Create.action ***!
  \*************************************************************************************/
/***/ ((module) => {

module.exports = {"ModalPageFullscreen":false,"ModalPage":true,"PageToOpen":"/RisksMobile/Pages/service1_Risk/Risk_Create.page","_Type":"Action.Type.Navigation"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/service1/Risk/NavToRisk_Detail.action":
/*!*************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/service1/Risk/NavToRisk_Detail.action ***!
  \*************************************************************************************/
/***/ ((module) => {

module.exports = {"_Type":"Action.Type.Navigation","PageToOpen":"/RisksMobile/Pages/service1_Risk/Risk_Detail.page"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/service1/Risk/NavToRisk_Edit.action":
/*!***********************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/service1/Risk/NavToRisk_Edit.action ***!
  \***********************************************************************************/
/***/ ((module) => {

module.exports = {"ModalPageFullscreen":false,"ModalPage":true,"PageToOpen":"/RisksMobile/Pages/service1_Risk/Risk_Edit.page","_Type":"Action.Type.Navigation"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/service1/Risk/NavToRisk_List.action":
/*!***********************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/service1/Risk/NavToRisk_List.action ***!
  \***********************************************************************************/
/***/ ((module) => {

module.exports = {"_Type":"Action.Type.Navigation","PageToOpen":"/RisksMobile/Pages/service1_Risk/Risk_List.page"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/service1/Risk/Risk_CreateEntity.action":
/*!**************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/service1/Risk/Risk_CreateEntity.action ***!
  \**************************************************************************************/
/***/ ((module) => {
...
/***/ "./build.definitions/RisksMobile/Actions/service1/Risk/Risk_DeleteEntity.action":
/*!**************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/service1/Risk/Risk_DeleteEntity.action ***!
  \**************************************************************************************/
/***/ ((module) => {

module.exports = {"Target":{"EntitySet":"Risk","Service":"/RisksMobile/Services/service1.service","ReadLink":"{@odata.readLink}"},"OnSuccess":"/RisksMobile/Actions/DeleteEntitySuccessMessage.action","OnFailure":"/RisksMobile/Actions/DeleteEntityFailureMessage.action","ActionResult":{"_Name":"delete"},"_Type":"Action.Type.ODataService.DeleteEntity"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/service1/Risk/Risk_UpdateEntity.action":
/*!**************************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/service1/Risk/Risk_UpdateEntity.action ***!
  \**************************************************************************************/
/***/ ((module) => {

module.exports = {"_Type":"Action.Type.ODataService.UpdateEntity","Target":{"EntitySet":"Risk","Service":"/RisksMobile/Services/service1.service","ReadLink":"{@odata.readLink}"},"Properties":{"title":"#Control:title/#Value","prio":"#Control:prio/#Value","descr":"#Control:descr/#Value","impact":"#Control:impact/#Value","criticality":"#Control:criticality/#Value","supplier_BusinessPartner":"#Control:supplier_BusinessPartner/#SelectedValue"},"UpdateLinks":[],"ActionResult":{"_Name":"update"},"OnSuccess":"/RisksMobile/Actions/UpdateEntitySuccessMessage.action","OnFailure":"/RisksMobile/Actions/UpdateEntityFailureMessage.action"}
